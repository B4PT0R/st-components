...
```bash
streamlit run examples/multipage_app.py
```
...
- `Page(...)("multipage_pages/report_page.py")` declares a file-backed page that Streamlit executes directly.
...
- `examples/multipage_app.py`: entrypoint, router, and inline page.
- `examples/multipage_pages/report_page.py`: file-backed page.
- `examples/multipage_shared.py`: shared state schema and reusable sidebar component used by both pages.
