    ...
    def render(self):
        return container(key="panel", border=True)(
            ...
            columns(key="controls")(
                button(key="case_0", on_click=self.set_case, args=(0,))("0"),
                button(key="case_1", on_click=self.set_case, args=(1,))("1"),
                button(key="case_2", on_click=self.set_case, args=(2,))("2"),
            ),
...
class SwitchDemo(Component):
    ...
    def render(self):
        return container(key="panel", border=True)(
            ...
            columns(key="controls")(
                button(key="loading", on_click=self.set_status, args=("loading",))("loading"),
                button(key="ready", on_click=self.set_status, args=("ready",))("ready"),
                button(key="other", on_click=self.set_status, args=("other",))("other"),
            ),
