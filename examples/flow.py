    ...
    def render(self):
        return container(key="panel", border=True)(
            ...
            columns(key="controls")(
                button(key="case_0", on_click=lambda _: self.set_case(0))("0"),
                button(key="case_1", on_click=lambda _: self.set_case(1))("1"),
                button(key="case_2", on_click=lambda _: self.set_case(2))("2"),
            ),
...
class SwitchDemo(Component):
    ...
    def render(self):
        return container(key="panel", border=True)(
            ...
            columns(key="controls")(
                button(key="loading", on_click=lambda _: self.set_status("loading"))("loading"),
                button(key="ready", on_click=lambda _: self.set_status("ready"))("ready"),
                button(key="other", on_click=lambda _: self.set_status("other"))("other"),
            ),
