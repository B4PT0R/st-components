...
class chat_input(Element):
    def __init__(
        ...
        *,
        ...
        Element.__init__(self, key=key, placeholder=placeholder, ref=ref, max_chars=max_chars, max_upload_size=max_upload_size, accept_file=accept_file, file_type=file_type, accept_audio=accept_audio, audio_sample_rate=audio_sample_rate, disabled=disabled, on_submit=on_submit, args=args, kwargs=kwargs, width=width, height=height)
