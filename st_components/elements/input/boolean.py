...
class checkbox(Element):
    ...
    def render(self):
        return st.checkbox(label_or_prop(self), key=_get_widget_key(), on_change=widget_callback(self), **widget_props(self))
...
class toggle(Element):
    ...
    def render(self):
        return st.toggle(label_or_prop(self), key=_get_widget_key(), on_change=widget_callback(self), **widget_props(self))
